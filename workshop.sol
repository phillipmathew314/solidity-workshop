...
contract LebronToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LebronToken() {
        ...
        name = "LebronToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LBJT";                                             // Set the symbol for display purposes (CHANGE THIS)
